...
tlink.exe build\main.obj build\render.obj build\error.obj build\stdio.obj build\fileio.obj build\tileset.obj build\board.obj build\util.obj >> build\out.txt
